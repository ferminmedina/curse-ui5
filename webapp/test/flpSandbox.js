		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customers",
									"targetURL": "#Globantcustomers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Globantcustomers-display": {
								"semanticObject": "Globantcustomers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Globant.customers",
									"url": sap.ui.require.toUrl("Globant/customers")
								}
							}
						}
					}
